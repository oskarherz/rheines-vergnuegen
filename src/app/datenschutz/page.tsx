...
export default function Privacy() {
  return (
    <main className="flex flex-col lg:max-w-4xl xl:max-w-6xl lg:mx-auto min-h-screen px-4 pt-12 pb-32 dark:bg-[#171717] text-slate-800 dark:text-slate-100 font-sans">

      <h1 className="my-16 text-6xl tracking-tighter font-serif italic font-light">
        Datenschutz
      </h1>

      <h2 className="text-3xl font-serif mb-4 mt-12">1. Datenschutz auf einen Blick</h2>
      ...
      <h3 className="text-lg font-semibold mb-2 mt-4">Datenerfassung auf unserer Website</h3>
      ...
      <h2 className="text-3xl font-serif mb-4 mt-12">3. Allgemeine Hinweise und Pflichtinformationen</h2>

      <h3 className="text-lg font-semibold mb-2 mt-4">Datenschutzerklärung</h3>
      ...
      <div className="p-4">
        ...
        <p>
          Telefon: +49 (0) 173 9525696<br />
          E-Mail: <a href="mailto:info@rheines-event.de">info@rheines-event.de</a>
        </p>
      </div>
      ...
      <h3 className="text-lg font-semibold mb-2 mt-4">Auskunft, Sperre, Löschung</h3>
      <p>
        Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten.
        Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden.
      </p>

      <h3 className="text-lg font-semibold mb-2 mt-4">Widerspruch gegen Werbe-Mails</h3>
      <p>
      ...
      <h2 className="text-3xl font-serif mb-4 mt-12">3. Datenerfassung auf unserer Website</h2>
      ...
      <h3 className="text-lg font-semibold mb-2 mt-4">Content Delivery Networks</h3>
      <p>
        Wir nutzen Content Delivery Networks (CDN) um die Auslieferung von Inhalten zu beschleunigen.
        Ein CDN ist ein Dienst, mit dessen Hilfe Inhalte unseres Onlineangebotes, insbesondere große Mediendateien, wie Grafiken oder Skripte mit Hilfe regional verteilter und über das Internet verbundener Server, schneller ausgeliefert werden.
      ...
      <p>
        ...
        Diese Webseite nutzt den Dienst Vercel. Der Anbieter ist Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA.
        Vercel ist eine Cloudplattform, über die wir unsere Webseite bereitstellen. Das bedeutet, dass der Besuch unser Webseite durch die Server von Vercel bearbeitet oder durchgeleitet wird.
        Soweit im Rahmen der vorliegenden Datenschutzerklärung nichts anderes erläutert wird, werden alle Zugriffsdaten sowie alle Daten, die in dafür vorgesehenen Formularen auf dieser Webseite erhoben werden, auf ihren Servern verarbeitet.
      ...
      <p>
        ...
        Zwingende gesetzliche Bestimmungen &ndash; insbesondere Aufbewahrungsfristen &ndash; bleiben unberührt.
      </p>

      <h2 className="text-3xl font-serif mb-4 mt-12">4. Analyse-Tools und Tracker</h2>

      <p>Wir setzen auf unserer Website folgende Analysetools uns Tracker ein:</p>

      <h3 className="text-lg font-semibold mb-2 mt-4">Vercel Insights</h3>
      <p>
        Vercel Insights ist ein Analyse-Tool, das von Vercel Inc. bereitgestellt wird. Es ermöglicht uns, Informationen über die Nutzung unserer Website zu sammeln und zu analysieren. Diese Informationen helfen uns, die Leistung und Benutzerfreundlichkeit unserer Website zu optimieren.
      </p>
      <p className="font-medium">
        Von uns verarbeitete personenbezogene Daten umfassen IP-Adresse, Browserinformationen, Geräteinformationen und Nutzungsdaten.
      </p>
      ...
      <h4 className="font-medium mb-1 mt-2">
        IP-Anonymisierung
      </h4>
      <p>
      ...
      <p>
        Weitere Informationen zum Umgang mit Nutzerdaten bei Google Analytics finden Sie in der Datenschutzerklärung von Google: <a href="https://policies.google.com/privacy?hl=de">https://policies.google.com/privacy?hl=de</a>.
      </p>
